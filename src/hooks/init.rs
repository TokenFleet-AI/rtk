...
# Docs: https://github.com/TokenFleet-AI/rtk#custom-filters
schema_version = 1
...
fn prompt_telemetry_consent() -> Result<()> {
    ...
    eprintln!("  Details: https://github.com/TokenFleet-AI/rtk/blob/master/docs/TELEMETRY.md");
    eprintln!();
    ...
    if patch_mode == PatchMode::Skip {
        println!(
            "\nManual setup needed: add RTK hook to {}\n\
             See: https://github.com/TokenFleet-AI/rtk#gemini-cli",
            settings_path.display()
        );
        return Ok(());
    }
