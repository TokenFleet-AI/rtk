...
Create `.rtk/filters.toml` in your project root to add custom filters or override built-ins. See [`src/filters/README.md`](https://github.com/TokenFleet-AI/rtk/blob/master/src/filters/README.md) for the full TOML DSL reference.
