...
- **Rust Token Killer** (`TokenFleet-AI/rtk`) — this project, a token-saving CLI proxy
...
```bash
curl -fsSL https://raw.githubusercontent.com/TokenFleet-AI/rtk/master/install.sh | sh
```

## Homebrew (macOS and Linux)

```bash
brew install TokenFleet-AI/tap/rtk
```
...
```bash
cargo install --git https://github.com/TokenFleet-AI/rtk rtk
```

## Pre-built binaries (Windows, Linux, macOS)

Download from [GitHub releases](https://github.com/TokenFleet-AI/rtk/releases):
