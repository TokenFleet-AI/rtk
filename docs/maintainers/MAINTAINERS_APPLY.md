...
1. Open a discussion in [TokenFleet-AI/rtk Maintainers Applications · Discussions · GitHub](https://github.com/TokenFleet-AI/rtk/discussions/categories/maintainers-applications) titled **Maintainer Application: [Your GitHub Handle]**
