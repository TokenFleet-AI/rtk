...
```bash
git clone https://github.com/TokenFleet-AI/rtk.git
cd rtk
cargo install --path .
...
```bash
curl -sSL https://github.com/TokenFleet-AI/rtk/releases/download/v0.16.0/rtk-linux-x86_64 -o rtk
chmod +x rtk
...
- **Fix**: Uninstall and reinstall correct RTK
  ```bash
  cargo uninstall rtk
  cargo install --path .  # From TokenFleet-AI/rtk repo
